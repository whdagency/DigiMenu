          ...
          >
            ...
            <SelectContent side="top">
              {[2, 5, 10, 15, 20].map((pageSize) => (
                ...
                <Dialog className=" p-8 shadow-lg h-[45rem] w-[65rem] rounded-xl justify-center ">
                ...
                <DialogContent style={{ padding: '2rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', height: '45rem', width: '45rem', maxWidth: '80rem', borderRadius: '1rem' }}>
                  <DialogHeader>
                    <h2 className="text-2xl font-bold mb-4 text-center">Create Promotion</h2>
